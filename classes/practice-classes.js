...
// const luigi = new Charater("Luigi", "humand");
// console.log(luigi.getInfo())
...
const newNPC = new NPC("Agnona", "dwarf", "tavern", "What'll it be?")
// console.log(newNPC)
// console.log(newNPC.dialogue())
...
class Player extends Character {
  ...
  defend(attack) {
    this.healthLevel - attack
    // console.log(this.healthLevel)
    if (this.healthLevel > 0) {
      return {
        attackStrength: attack,
        remainingHealth: this.healthLevel - attack,
...
fireSpitter.addSuperPower('destroy');
const fireSpitterAttack = fireSpitter.useSuperPower(0)
console.log(fireSpitter.useSuperPower(0))
